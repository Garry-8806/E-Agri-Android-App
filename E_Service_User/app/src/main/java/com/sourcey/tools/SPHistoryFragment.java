...
public class SPHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sphistory, container, false);
    ...
    public class GetBookingInfo extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            JSONObject object = jsonParser.makeHttpRequest(ServerUtility.url_get_sp_payment_history(), "GET", params);
            try {
                JSONArray array = object.getJSONArray("BookingInfo");
                paymentHistoryAdapter = new PaymentHistoryAdapter(SPHistoryFragment.this.getContext(), R.layout.single_payment_history);
                for (int i = 0; i < array.length(); i++) {
                    ...
                    toolRequest.setSp_name(cust_name);
