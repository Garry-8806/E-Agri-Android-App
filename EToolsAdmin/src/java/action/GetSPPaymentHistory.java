 ...
 * @author Dinesh
 */
public class GetSPPaymentHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT ttr.*,tui.username,tui.mobile FROM tbl_tool_requests ttr inner join tbl_user_reg tui on ttr.cust_email=tui.email WHERE ttr.request_status='Completed' and ttr.sp_email='" + username + "'";
