 ...
 * @author Dinesh
 */
public class GetCustomerPaymentHisory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            String sql = "SELECT ttr.*,tui.username,tui.mobile FROM tbl_tool_requests ttr inner join tbl_user_reg tui on ttr.sp_email=tui.email WHERE ttr.request_status='Completed' AND ttr.cust_email='" + email + "'";
            ...
            while (rs.next()) {
                ...
                object.put("sp_name", rs.getString("username"));
