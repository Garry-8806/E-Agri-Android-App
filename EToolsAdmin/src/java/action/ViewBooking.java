...
public class ViewBooking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT ttr.*,tui.username,tui.mobile FROM etools.tbl_tool_requests ttr inner join tbl_user_reg tui on ttr.sp_email=tui.email WHERE ttr.cust_email='" + email + "'";
